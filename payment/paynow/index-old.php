...
<div align="center" class="wrapper">
    ...
    <div class="form_container">
        ...
        if ($statementdescriptor == 'DESIGNQUOTATIONS.COM') {
            ...
            ?>
            <!--<h1><img src="https://logoinvinci.com/assets/images/logo.png"> Payment Terminal</h1>-->
...
<div class="clr"></div>
                    ...
                    <div class="pane">
                        ...
                        <div class="ccinfo">
                            ...
                            <input name="ccn" id="ccn" type="text" class="long-field<? if ($isadmin) echo " text-basic"; ?>"
    ...
    position: relative;
    text-align: left;
    width: 80%;"><input type="checkbox" value="1" id="cc_terms" checked /> I accept Terms & Conditions</a></label>
                      ...
                      <div class="clr"></div>
                      <div class="submit-btn"><input src="images/btn-new.jpg" type="image" name="submit"></div>
...
s1.async=true;
s1.src='https://embed.tawk.to/5e9204d869e9320caac2a424/default';
s1.charset='UTF-8';
