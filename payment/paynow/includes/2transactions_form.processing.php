...
$link = mysqli_connect('localhost', 'logoliberty_payment', '@2+Td+vp;Ib&', 'logoliberty_payment');
if (!$link) {
...
// Performing SQL query
                    ...
                    switch ($stripe_success) {
                        ...
                        case 1:  // Successs
                            $sMessageResponse = "<br/><div>YOU HAVE BEEN SUCCESSFULLY CHARGED A TOTAL AMOUNT OF ".$AccountCurrency . $original_amount." IN 2 SEPARATE TRANSACTIONS.</div>";
                            $sMessageResponse .= "<br /><div>Your payment was <b>APPROVED</b>!";
                            $sMessageResponse .= "<div>";
                            $sMessageResponse .= "Gateway Response:" . $return_msg;
                            $sMessageResponse .= "</div>";
                            $sMessageResponse .= "<br/><a href='https://logoliberty.com/'>Return to payment page</a><br /><br/></div>";
                            ...
                            */
                            ...
                            // Send to Hassan Zaman for CRM
                            mail("hassan.zaman@tradekey.com",$subject,$message,$headers);
