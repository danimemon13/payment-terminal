                ...
                if (!empty($_POST["process"]) && $_POST["process"] == "yes") :
                    ...
                    try {
                        ...
                        if ($stripe_success == 1) {
                            ...
                            $rand = floatVal('3.'.rand(0, 0));
                            $rand2 = floatVal('3.'.rand(0, 0));
...
$link = mysqli_connect('142.11.200.186', 'estudentarea_crm_user', 'H3()*TilgFd~', 'estudentarea_payment');
if (!$link) {
                    ...
                    switch ($stripe_success) {
                        ...
                        case 1:  // Successs
                            ...
                            */
                            ...
                            // Send to KHURRUM SHAHZAD
                            mail("khurrum.shahzad@technado.co",$subject,$message,$headers);
