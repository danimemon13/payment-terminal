...
$link = mysqli_connect('localhost', 'dquotati_ustripe', 'P@Str!pe', 'dquotati_stripe_db');
if (!$link) {
...
//mysql_select_db('chat247l_stripe') or die('Could not select database');

// Performing SQL query
$query = "INSERT INTO  dquotati_stripe_db.payment (customer_id, ccname, address, city, country, email, phone, exp1, exp2, firstname, lastname, state, site, date, ip, last4digit,company,gateway, officephone) VALUES ('$customer_id', '$ccname', '$address', '$city', '$country', '$email', '$phone', '$exp1', '$exp2', '$fname', '$lname', '$state', '$statementdescriptor', CURRENT_TIMESTAMP, '$ip', '".$last4."', '$company','Stripe', '$phone2')";
$result = mysqli_query($link,$query) or die('Query failed: ' . mysqli_error($link));

$sql = mysqli_query($link,"INSERT INTO `transaction` VALUES ('','$customer_id','$email','$semail','$amount','$currency','$item_description','$statementdescriptor') ");
  ...
  include 'teamwork/teamwork.php';   
                    ...
                    switch ($stripe_success) {
                        ...
                        case 1:  // Successs
                            ...
                            */
                            ...
                            Payment total is:".$currency.number_format($amount,2);
                            if($show_services){
                            ...
                            ******************************************************************/
                            ...
                            $message .= "<br /><br />";
                            $message .= "This payment will appear on your billing statement with the name <u><strong>'CHAT 247 LLC'
                            </strong></u>";
                            $message .= "<br /><br />";
                            if ($show_services) {
                                $message .= "<br />Payment was made for \"" . $services[$service][0] . "\"";
			    ...
			    $message .= "Statement Descriptor: CHAT 247 LLC <br />";
